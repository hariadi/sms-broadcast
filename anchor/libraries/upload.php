...
class Upload {
	...
	public function __construct($destination) {
      ...
      define('ROOT', dirname(__FILE__) . DIRECTORY_SEPARATOR);
		...
		if (!$this->set_destination($destination)) {
			...
			throw new ErrorException('Upload: Can\'t create destination.');
	...
	public function set_filename($filename) {
		...
		$this->filename = $filename . $this->get_extension($this->file_post['name']);
	...
	protected function save_file() {
		...
		if (!$status) {
			throw new ErrorException('Upload: Can\'t upload file.');
		}
	...
	public function callbacks($instance_of_callback_object, $callback_methods) {
		...
		if (empty($instance_of_callback_object)) {
			...
			throw new ErrorException('Upload: $instance_of_callback_object can\'t be empty.');
			
		}
		
		if (!is_array($callback_methods)) {
			
			throw new ErrorException('Upload: $callback_methods data type need to be array.');
